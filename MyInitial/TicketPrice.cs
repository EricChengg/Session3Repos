...
namespace Ticketing
{
    ...
    public TicketPrice(int section, int quantity, bool discount,bool child, decimal odiscount)
    {
        Section = section;
        Quantity = quantity;
        Discount = discount;
     ...
     public void calculatePrice()
     {
         ...
         AmountDue = (mPrice - odiscount) * quantity;
